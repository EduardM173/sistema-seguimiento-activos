...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="Asset Tracking — AI Assistant",
        description=(
            "LlamaIndex + Google GenAI (Gemini) conversational assistant with:\n"
            "- Neo4j PropertyGraph for domain knowledge retrieval\n"
            "- RAG-enabled chat with conversation memory\n"
            "- Deeplink annotation for SPA navigation\n"
